...
3. **Duplication de scripts/pages**
   - des doublons de fichiers (`concerts (1).html`, `sports (1).html`, `sheets-loader (1).js`) ont été identifiés puis retirés.
   - conserver une seule source par page/script évite la confusion de maintenance / déploiement.
